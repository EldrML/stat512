...
m_1stOrd = lm(ERP ~ . + I(MYCT^MYCT_Tran[1]$lambda), data=numdata)
...
m_full = lm(ERP ~ . ^2 + I(MYCT^MYCT_Tran[1]$lambda) - MYCT, data=numdata)
...
anova(m_best)
summary(m_best)
print.Anova( anova(m_base, m_full, m_step, m_back, m_for, m_ex8))